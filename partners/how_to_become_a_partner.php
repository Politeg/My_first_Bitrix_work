...
$APPLICATION->SetPageProperty("keywords", "партнёр, партнёрство, компания, как стать партнёром");
$APPLICATION->SetPageProperty("description", "Как стать партнёром");
...
<tr>
	<td>
		<p>
			<img width="263" alt="Управление сайтом.png" src="/upload/medialibrary/5f8/r162q8v83mflu4jttkgp4oe1ywusze1d.png" height="263" title="Управление сайтом.png"><br>
		</p>
	</td>
	<td>
		<ul type="disc">
